function image = oldedgeresponse(im, M, S)
        im = imcomplement(im);

        %cmfrat filters 0, 20, 40, 60, 80, 100, 120, 140, 160
        f0 = oldcmfrat(11, 11, 0, M, S);
        f20 = oldcmfrat(11, 11, 20, M, S);
        f40 = oldcmfrat(11, 11, 40, M, S);
        f60 = oldcmfrat(11, 11, 60, M, S);
        f80 = oldcmfrat(11, 11, 80, M, S);
        f100 = oldcmfrat(11, 11, 100, M, S);
        f120 = oldcmfrat(11, 11, 120, M, S);
        f140 = oldcmfrat(11, 11, 140, M, S);
        f160 = oldcmfrat(11, 11, 160, M, S);
